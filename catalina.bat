...
rem if not exist "%CATALINA_BASE%\bin\mysql-connector-java-8.0.16.jar" goto jdbcClasspathH
set "CLASSPATH=%CLASSPATH%;%CATALINA_BASE%\bin\mysql-connector-java-8.0.16.jar;C:\Users\sesioliktas\Desktop\server\tomcat\webapps\pvz"
rem goto jdbcClasspathDone
